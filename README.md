...
<div>
  ...
  <ul>
    <li>🚀 <a href="enlace al repositorio">JAVA ONE PIECE GAME</a>: Videojuego creado en Java a través de Java.swing sobre One Piece</li>
    <li>🌟 <a href="enlace al repositorio">GUIA DE USO ONE PIECE</a>: Página web sobre la guía de uso del videojuego, HTML / CSS / JS .</li>
  </ul>
